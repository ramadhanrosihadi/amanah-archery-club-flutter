...
class Nav {
  ...
  static Future<dynamic> push<T extends Object>(BuildContext context, Widget widget) {
    return Navigator.push(context, MaterialPageRoute(builder: (context) => widget));
  }

  static Future<dynamic> pushReplacement<T extends Object>(BuildContext context, Widget widget) {
    return Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => widget));
  }

  static Future<dynamic> pushAndRemoveUntil<T extends Object>(BuildContext context, Widget widget) {
